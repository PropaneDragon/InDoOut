...
namespace InDoOut_Core.Entities.Functions
{
    ...
    /// </summary>
    public interface IResult : INamedValue
    {
        /// <summary>
        ...
        /// <see cref="INamedValue.RawValue"/> inside the given <paramref name="variableStore"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets a variable's value directly from the <see cref="INamedValue.RawValue"/> without
