...
namespace InDoOut_Core_Tests
{
    internal class TestFullFunction : Function
    {
        ...
        public Property<int> IntegerProperty = new("An integer property", "This is a property that stores an int", false);
        public Property<double> DoubleProperty = new("A double property", "This is a property that stores a double", false);
        public Property<float> FloatProperty = new("A float property", "This is a property that stores a float", false);
        public Property<string> StringProperty = new("A string property", "This is a property that stores a string", false);

        public Result IntegerResult = new("Integer output", "An output that gives the input for an int");
        public Result DoubleResult = new("Double output", "An output that gives the input for a double");
        public Result FloatResult = new("Float output", "An output that gives the input for a float");
        public Result StringResult = new("String output", "An output that gives the input for a string");
