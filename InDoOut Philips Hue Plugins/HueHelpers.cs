...
namespace InDoOut_Philips_Hue_Plugins
{
    ...
    {
        private static readonly CacheControlHeaderValue _cacheControl = new() { NoCache = true, NoStore = true };
        private static readonly Dictionary<string, HueClient> _clientStorage = new();
